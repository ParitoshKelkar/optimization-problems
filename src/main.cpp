...
int main()
{
    VehicleParams vehicle_params(1); // 1 for Ashphalt, 2 for Wet ashphalt, 3 for Snow
    ...
    Plant my_suv(vehicle_params);

    // Define initial condition of vehicle before defining an object of simulation. To be contd..
